...
const prizes: WheelPrize[] = [
  ...
  {
    id: "followers-10",
    label: "2K Followers -10%",
    percentage: 10,
    productName: "2K Followers",
  },
];
...
function WheelGame() {
  ...
  const spinWheel = () => {
    ...
    /*
      On marque immédiatement le mois comme utilisé.
      Même si le client recharge pendant l'animation,
      il ne pourra pas rejouer.
    */
    markSpinForCurrentMonth();
    ...
    window.setTimeout(() => {
      const reward = createWheelReward({
        id: winningPrize.id,
